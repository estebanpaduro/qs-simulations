...
def simulation_FHN_exp2(model, protocol, func, time, threshold , parameters_hf, parameters_dc, initial):
    ...
    #dist=(1/(200/s.last_number_of_steps()))
...
def run_experiment2(current, frequency, range_delta, range_rho):
    ...
    for delta in delta_range:
        for rho in rho_range:
            progress = progress+1
            param= parameters_simulation_FHN_exp2(current,frequency,delta,rho)
...
def plot_single_simulation_FHN_exp2(current, frequency, delta, rho):

    param= parameters_simulation_FHN_exp2(current,frequency,delta,rho)
    df_times, _ = simulation_FHN_exp2(param["model"]
                                       , param["protocol"]
                                       , param["functions"]
                                       , param["time"]
                                       , param["threshold"]
